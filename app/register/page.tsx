...
export default function Register() {
  ...
  const handleRegister = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: Ganti ini dengan logika API call ke backend Anda
      ...
      <div className="w-full lg:w-1/2 flex flex-col h-screen overflow-y-auto px-8 py-12 lg:px-16 scrollbar-hide">
        <div className="max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            {/* Nama Input */}
            <div>
              <label className="block text-gray-300 text-sm mb-2 font-medium">Nama Lengkap</label>
              <input
                type="text"
                name="nama"
                value={formData.nama}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <label className="block text-gray-300 text-sm mb-2 font-medium">NIM</label>
                <input
                  type="text"
                  name="nim"
                  value={formData.nim}
              ...
              <div>
                <label className="block text-gray-300 text-sm mb-2 font-medium">No HP / WA</label>
                <input
                  type="tel"
                  name="noHp"
                  value={formData.noHp}
            ...
            {/* Status Dropdown */}
            <div>
              <label className="block text-gray-300 text-sm mb-2 font-medium">Status Saat Ini</label>
      ...
      <div className="hidden lg:flex w-1/2 relative h-screen sticky top-0 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white px-12 z-10 text-center">
            <h2 className="text-5xl font-bold mb-6 drop-shadow-lg leading-tight">
                KELUARGA BESAR<br/><span className="text-red-500">TEKNIK INFORMATIKA</span>
            </h2>
            <p className="text-xl text-gray-200 font-light max-w-lg">
                Bergabunglah untuk mempererat silaturahmi dan membangun koneksi profesional antar alumni Universitas Hasanuddin.
            </p>
        </div>
      </div>
    </div>
