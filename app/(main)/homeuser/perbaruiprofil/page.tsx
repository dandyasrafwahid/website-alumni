...
export default function EditProfilePage() {
  ...
  const [provinsiTempatKerja, setProvinsiTempatKerja] =
    useState("Sulawesi Selatan");
  const [kotaKabupaten, setKotaKabupaten] = useState("Makassar");
  const [daftarKota, setDaftarKota] = useState<string[]>(
    DATA_WILAYAH["Sulawesi Selatan"],
  );
      ...
      <div className="relative bg-[#0F3555] pt-32 pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center lg:text-left">
          ...
          <p className="text-blue-100 text-lg md:text-xl max-w-3xl leading-relaxed">
            Perbarui data diri, karir, dan informasi akun Anda agar tetap
            relevan.
          </p>
        </div>
      ...
      <div className="container mx-auto px-6 py-12 flex-grow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-1">
            <h2 className="text-2xl font-bold text-[#0F3555] mb-3">
              Informasi Dasar
            </h2>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F3555] text-gray-900 font-medium placeholder-gray-500 bg-white"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F3555] text-gray-900 font-medium bg-white"
                  />
                </div>
                <div>
                  <label className="block text-gray-900 font-bold mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 bg-white p-8 rounded-xl shadow-md border border-gray-200">
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F3555] text-gray-900 bg-white"
                    />
                  </div>
                  <div>
                    <label className="block text-gray-900 font-bold mb-2">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8 pr-4 py-3 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F3555] text-gray-900 bg-white"
                    />
                  </div>
                </div>
                ...
                <h3 className="text-xl font-bold text-[#0F3555] mb-4">
                  Informasi Pekerjaan
                </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F3555] bg-white text-gray-900 cursor-pointer">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0F3555] bg-white text-gray-900"
                    />
                  </div>
                  <div>
                    <label className="block text-gray-900 font-bold mb-2">
                  ...
                  <div className="pt-4 text-right">
                    <button
                      ...
                      className="px-6 py-2.5 bg-gray-800 hover:bg-black text-white font-bold rounded-lg transition-colors shadow-md">
                      Update Kata Sandi
                    </button>
                  </div>
                </div>
