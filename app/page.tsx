...
export default function Home() {
  ...
  const homeNewsletters = [
    { id: 1, title: "ACTION 2025", edition: "Desember 2025", image: "/DSC09820.JPG" },
    { id: 2, title: "ACTION 2025", edition: "Oktober 2025", image: "/DSC09820.JPG" },
    { id: 3, title: "ACTION 2025", edition: "Agustus 2025", image: "/DSC09820.JPG" },
    { id: 4, title: "ACTION 2025", edition: "Mei 2025", image: "/DSC09820.JPG" },
  ];
      ...
      <div
        ...
        <div className="w-full bg-white pt-12 pb-12 rounded-t-3xl mt-[-20px] z-10 relative space-y-20">
          ...
          <div className="max-w-7xl mx-auto px-6 space-y-10">
            ...
            <section className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row items-stretch border border-gray-100">
              <div className="lg:w-2/3 p-10 md:p-16 flex flex-col justify-center">
                <h2 className="text-2xl lg:text-3xl font-bold text-gray-800">Dana Abadi Untuk Unhas Maju</h2>
                <p className="mt-6 text-gray-600 leading-relaxed max-w-2xl">
                  Dana Abadi yang terkumpul ditampung pada rekening bank Rektor Universitas Hasanuddin...
                </p>
              ...
              <div className="lg:w-1/3 relative shrink-0">
                <div className="h-56 md:h-auto lg:h-full w-full overflow-hidden">
                  <Image src="/DSC09820.JPG" alt="Kampus" width={1200} height={800} className="object-cover h-full w-full" />
                </div>
              </div>
            </section>
            ...
            <section className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col lg:flex-row items-stretch border border-gray-100">
              <div className="lg:w-1/3 relative shrink-0 order-2 lg:order-1">
                <div className="h-56 md:h-auto lg:h-full w-full overflow-hidden">
                  <Image src="/DSC09820.JPG" alt="Survei" width={1200} height={800} className="object-cover h-full w-full" />
                </div>
              </div>
              <div className="lg:w-2/3 p-10 md:p-16 flex flex-col justify-center order-1 lg:order-2">
                <h3 className="text-2xl lg:text-3xl font-bold text-gray-800">Survei Penjaringan Alumni</h3>
                <p className="mt-6 text-gray-600 leading-relaxed max-w-2xl">
                  Survei ini ditujukan untuk para alumni unhas yang lulus pada tahun 2010...
                </p>
                <div className="mt-8 w-full lg:w-1/2">
                  <button className="w-full bg-[#0b3b57] hover:bg-[#0d4f6f] text-white py-4 rounded-lg font-semibold tracking-wide shadow-md transition-colors">
                    ISI SURVEI &nbsp; ➜
          ...
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">News and Events</h2>
            <div className="flex flex-row gap-8 pb-4 overflow-x-auto scrollbar-hide">
              ...
              <div className="flex-shrink-0 w-80 rounded-xl overflow-hidden shadow-md border border-gray-100 group cursor-pointer">
                <div className="relative h-48 w-full">
                  <Image src="/DSC09820.JPG" alt="News" width={320} height={192} className="object-cover w-full h-full group-hover:scale-110 transition-transform" />
                </div>
                <div className="bg-white p-5">
                  <h3 className="text-gray-800 font-semibold line-clamp-2 group-hover:text-blue-600">Sosok Alumni Berprestasi</h3>
                </div>
              </div>
              {/* Card News 2 */}
              <div className="flex-shrink-0 w-80 rounded-xl overflow-hidden shadow-md border border-gray-100 group cursor-pointer">
                ...
                <div className="bg-white p-5">
                  <h3 className="text-gray-800 font-semibold line-clamp-2 group-hover:text-blue-600">Perayaan Maulid Universitas</h3>
                </div>
              </div>
              {/* Card News 3 */}
              <div className="flex-shrink-0 w-80 rounded-xl overflow-hidden shadow-md border border-gray-100 group cursor-pointer">
                ...
                <div className="bg-white p-5">
                  <h3 className="text-gray-800 font-semibold line-clamp-2 group-hover:text-blue-600">Employer Meeting</h3>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-end mt-4">
              <Link href="/news" className="text-blue-600 font-semibold hover:text-blue-800 flex items-center gap-2 transition-colors">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">Newsletter</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {homeNewsletters.map((item) => (
                <div key={item.id} className="relative group rounded-xl overflow-hidden shadow-lg aspect-[3/4] cursor-pointer">
            ...
            <div className="flex justify-end mt-6">
              <Link href="/newsletter" className="text-blue-600 font-semibold hover:text-blue-800 flex items-center gap-2 transition-colors">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">Jobs and Vacancy</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="text-blue-600 font-bold text-lg uppercase">Job Vacancy And Opportunities</h3>
                    <p className="text-gray-800 font-semibold mt-1">OPEN RECRUITMENT - ODP REGIONAL BUSINESS</p>
                    <p className="text-gray-500 text-sm mt-1">BANK MANDIRI 🌏 Bank Mandiri membuka...</p>
                  </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="text-blue-600 font-bold text-lg uppercase">Pengadaan PPPK</h3>
                    <p className="text-gray-800 font-semibold mt-1">Halo Alumni Universitas Hasanuddin...</p>
                    <p className="text-gray-500 text-sm mt-1">Direktorat Hubungan Alumni ingin berbagi info...</p>
                  </div>
                  <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-gray-400">
                    ↗
                  </div>
            ...
            <div className="flex justify-end mt-6">
              <Link href="/jobs" className="text-blue-600 font-semibold hover:text-blue-800 flex items-center gap-2 transition-colors">
                Lihat Berita Selengkapnya <span>→</span>
              </Link>
            </div>
          </div>
          ...
          <div id="about-section" className="w-full bg-gradient-to-b from-blue-50 to-white py-16 px-6 rounded-xl">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
              <div className="flex-1">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <p className="text-gray-800 font-bold mb-3">Info lebih lanjut silahkan menghubungi :</p>
                  <p className="text-gray-600 text-sm flex items-center gap-2">✓ (+62) 812 5358 4528</p>
                  <p className="text-gray-600 text-sm flex items-center gap-2 mt-2">✓ (+62) 812 4327 8997</p>
                  <p className="text-gray-600 text-sm flex items-center gap-2 mt-4 font-semibold">
                    E-mail : <span className="text-blue-600">informatika@unhas.ac.id</span>
                  </p>
                </div>
              </div>
              <div className="flex-1 w-full h-[400px] rounded-2xl overflow-hidden shadow-2xl relative">
                <Image src="/kampus03.png" alt="Unhas" fill className="object-cover" />
              </div>
            </div>
          </div>
        ...
        {/* Footer */}
        <footer className="footer bg-[#152C6B] text-white px-10 py-6 items-center">
          <aside className="flex items-center gap-4">
            <Image src="/unhas-logo.png" alt="Logo" width={48} height={48} />
          ...
          <nav className="md:place-self-center md:justify-self-end">
             <p className="text-sm opacity-70">© 2025 Alumni Informatika Unhas</p>
          </nav>
        </footer>
      </div>
